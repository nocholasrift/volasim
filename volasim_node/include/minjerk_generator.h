...
class MinJerkGenerator {
 public:
  ...
  vola::trajectory_t get_trajectory(const Eigen::Vector3d& curr_pos,
                                    const Eigen::Vector3d& target_pos,
                                    double time, double step_size = 1e-2);
 ...
 private:
  ...
  Eigen::Matrix<double, kDegree, kNumAxes> get_traj_coefficients(
